...
export const eicProducts: EICProduct[] = [
  ...
  // --- GREEN TRANSFO ---
  {
    ...
    category: "Transformadores",
    categorySlug: "transformadores",
    features: ["135 MVA", "170 kV", "Manufactura sostenible", "Materiales eco-amigables", "Legado AEG/Alstom/Areva", "60+ años de experiencia"],
    ...
    specs: [
      ...
      { label: "Capacidad", value: "135 MVA" },
      { label: "Voltaje", value: "170 kV" },
