...
export const certifications: Certification[] = [
  ...
  },
  {
    ...
    name: "ANSI/IEEE C57",
    slug: "ansi-ieee-c57",
    fullName: "Norma ANSI/IEEE C57 — Certificación en trámite con CIDET (Acreditado por ANAB)",
    description: "Estamos en proceso de certificar nuestros transformadores con CIDET — acreditado por ANAB (la principal entidad de acreditación de América del Norte) — bajo la norma ANSI/IEEE C57, el estándar internacional que rige el diseño, desempeño, pruebas y seguridad de transformadores eléctricos, publicado por el Institute of Electrical and Electronics Engineers (IEEE) y acreditado por el American National Standards Institute (ANSI). El trámite se encuentra actualmente en curso.",
    issuingBody: "CIDET (Acreditado por ANAB)",
    inProcess: true,
    benefits: [
      "Acreditará el cumplimiento del estándar técnico más riguroso para transformadores",
      "Será emitida por CIDET, acreditado por ANAB",
      "Validará el diseño y las pruebas conforme a IEEE C57.12.00 y C57.12.90",
      "Abrirá el acceso a mercados que exigen cumplimiento ANSI/IEEE",
  ...
  },
  {
    ...
    name: "UL XPLH",
    slug: "ul",
    fullName: "UL XPLH: Transformers, Distribution, Liquid-filled Type, Over 600 Volts — Registro en trámite",
    description: "Estamos en proceso de registrar nuestra familia de productos ante UL (Underwriters Laboratories), la organización de certificación de seguridad eléctrica líder en América del Norte. Una vez completado, el registro garantizará a nuestros clientes que los equipos han sido evaluados bajo los estándares de seguridad más exigentes del mercado. El trámite se encuentra actualmente en curso.",
    issuingBody: "Underwriters Laboratories Inc.",
    inProcess: true,
    benefits: [
      "Registrará nuestra familia de productos ante UL",
      "Someterá los equipos a los estándares de seguridad eléctrica más exigentes",
      "Ampliará el reconocimiento en mercados de América del Norte",
