    ...
    <div className="min-h-screen bg-white flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-xl mx-auto">
        ...
        <p className="text-gray-500 text-lg mb-10 leading-relaxed">
          Lo sentimos, la pagina que buscas no existe o ha sido movida. Te invitamos a explorar nuestras secciones principales.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-10">
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-700">Marcas Internacionales</span>
          </Link>
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-700">Remanufacturados</span>
          </Link>
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-700">Nuevos USA</span>
          </Link>
        </div>
