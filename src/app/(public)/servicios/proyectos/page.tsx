        ...
        <div className="container-eminsa">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-12 h-12 bg-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center text-[#001689] hover:text-[#FF5500] transition-all duration-300 hover:scale-110 hidden md:flex"
              aria-label="Anterior"
            >
              <ChevronLeft size={24} />
            </button>
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-12 h-12 bg-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center text-[#001689] hover:text-[#FF5500] transition-all duration-300 hover:scale-110 hidden md:flex"
              ...
              {proyectosDestacados.map((project, index) => (
                ...
                >
                  <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 h-full">
                    {/* Top gradient stripe */}
                    <div className="h-2 bg-gradient-to-r from-[#FF5500] to-[#CC4400]" />

                    {/* Image placeholder area */}
                    <div className="h-48 bg-gradient-to-br from-[#FF5500]/5 to-[#FF5500]/10 flex items-center justify-center relative">
                      <Settings className="w-16 h-16 text-[#FF5500]/20" />
                      <div className="absolute top-3 right-3">
                        <span className="px-3 py-1 bg-[#FF5500] text-white text-xs font-bold rounded-full">
                          {project.tipoServicio}
                        </span>
                      </div>
                      {/* Decorative circles */}
                      <div className="absolute bottom-3 left-3 w-20 h-20 bg-[#FF5500]/5 rounded-full" />
                      <div className="absolute top-6 left-6 w-8 h-8 bg-[#001689]/5 rounded-full" />
                    </div>

                    {/* Content */}
                    <div className="p-6">
                      <h3 className="text-lg font-bold text-[#001689] mb-2 group-hover:text-[#FF5500] transition-colors line-clamp-2">
                        {project.titulo}
                      </h3>
                      ...
                      {/* View more hint */}
                      <div className="flex items-center gap-2 text-[#FF5500] text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              ...
              {proyectosDestacados.map((_, index) => (
                <button
                  ...
                  className={`transition-all duration-300 rounded-full ${
                    activeIndex === index
                      ? "w-8 h-3 bg-[#FF5500]"
                      : "w-3 h-3 bg-gray-300 hover:bg-[#FF5500]/50"
                  }`}
        ...
        {selectedProject && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setSelectedProject(null)}
                className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/90 hover:bg-white shadow-lg flex items-center justify-center z-10 text-[#001689] hover:text-[#FF5500] transition-all hover:scale-110"
                aria-label="Cerrar"
              >
                <X size={24} />
              </button>
              ...
              {/* Header gradient */}
              <div className="bg-gradient-to-r from-[#FF5500] to-[#CC4400] p-8 text-white relative overflow-hidden">
                {/* Decorative elements */}
              ...
              <div className="p-8">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    {selectedProject.resultados.map((resultado, i) => (
                      <motion.div
                        ...
                        className="flex items-start gap-3 bg-[#FF5500]/5 rounded-xl p-4"
                      >
                        <CheckCircle2
                          size={18}
                ...
                <div className="mt-8 pt-6 border-t border-gray-100 flex flex-wrap gap-4">
                  <Link
                    href="/servicios/cotizacion"
                    className="inline-flex items-center gap-2 px-6 py-3 bg-[#FF5500] text-white font-semibold rounded-xl hover:bg-[#E04D00] transition-all shadow-md hover:shadow-lg"
                  >
            ...
            {proyectosServicios.map((project, index) => (
              ...
              >
                <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 h-full">
                  {/* Top gradient stripe */}
                  <div className="h-1.5 bg-gradient-to-r from-[#FF5500] via-[#E04D00] to-[#CC4400]" />
                  ...
                  <div className="p-6">
                    ...
                    {/* View more hint */}
                    <div className="flex items-center gap-2 text-[#FF5500] text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300 pt-2 border-t border-gray-100">
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container-eminsa">
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#FF5500]/5 rounded-full blur-[100px]" />

            <div className="relative z-10 max-w-2xl mx-auto">
              <Settings size={48} className="mx-auto mb-6 text-[#FF5500]" />
