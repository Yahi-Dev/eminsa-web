...
export default function ProductoSlugContent({ slug }: Props) {
  ...
  const productPhotos: Record<string, { main: string; secondary: string[] }> = {
    ...
    "subestacion": {
      ...
      secondary: ["https://res.cloudinary.com/dixsymrg5/image/upload/f_auto,q_auto/v1775242342/eminsa/site/fotos-eminsa/mtn/DSC07753.jpg", "https://res.cloudinary.com/dixsymrg5/image/upload/f_auto,q_auto/v1775242331/eminsa/site/fotos-eminsa/mtn/DSC07172.jpg"],
    },
  };
