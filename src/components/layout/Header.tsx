      ...
      <div className="hidden lg:block bg-[#00269b] text-white text-xs xl:text-sm">
        <div className="container-eminsa flex items-center justify-between py-2">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <Image
                src={language === "en" ? "https://res.cloudinary.com/dixsymrg5/image/upload/f_auto,q_auto/v1775242381/eminsa/site/images/eic/flags/estados-unidos.png" : "https://res.cloudinary.com/dixsymrg5/image/upload/f_auto,q_auto/v1775242384/eminsa/site/images/eic/flags/republica-dominicana.png"}
                alt=""
                width={20}
                height={14}
      ...
      >
        <div className={cn(
          ...
          >
            ...
            >
              <Image
                src="https://res.cloudinary.com/dixsymrg5/image/upload/f_auto,q_auto/v1775242404/eminsa/site/logoeminsa-Photoroom.png"
                alt="Grupo EMINSA"
                width={240}
                height={240}
                className={cn(
            ...
            >
              <div className="container-eminsa py-4">
                ...
                <div className="mt-6 space-y-3">
                  ...
                  >
                    <Image
                      src={language === "en" ? "https://res.cloudinary.com/dixsymrg5/image/upload/f_auto,q_auto/v1775242384/eminsa/site/images/eic/flags/republica-dominicana.png" : "https://res.cloudinary.com/dixsymrg5/image/upload/f_auto,q_auto/v1775242381/eminsa/site/images/eic/flags/estados-unidos.png"}
                      alt=""
                      width={22}
                      height={15}
                      className="rounded-sm object-cover shrink-0"
